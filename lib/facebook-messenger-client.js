...
//MOVE: API Methods into seperate api object
...
FacebookMessengerClient.prototype.send = function(meta, text) {
...
FacebookMessengerClient.prototype.startTyping = function(meta) {
...
FacebookMessengerClient.prototype.markAsRead = function(meta) {
  var messageData = {
    recipient: {
      id: meta.user
    },
