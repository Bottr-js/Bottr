...
Bot.prototype.hears = function(patterns, eventFilter, custom_hear_middleware, callback) {
  this.botkitBot.hears(patterns, eventFilter, custom_hear_middleware, this.createHandler('listener ' + patterns, callback))
}
